...
#define CVEC_NEW_VEC_DECLS(TYPE)                                               \
  ...
  int cvec_insert_array_TYPE(cvector_TYPE *vec, size_t i, TYPE *a,             \
                             size_t num);                                      \
...
#define CVEC_NEW_VEC_DEFS(TYPE)                                                \
  ...
  int cvec_push_TYPE(cvector_TYPE *vec, TYPE a) {                              \
    ...
    return 1;                                                                  \
                                                                               ...
                                                                               \
  TYPE cvec_pop_TYPE(cvector_TYPE *vec) { return vec->a[--vec->size]; }        \
                                                                               \
  TYPE *cvec_back_TYPE(cvector_TYPE *vec) { return &vec->a[vec->size - 1]; }   \
                                                                               \
  int cvec_extend_TYPE(cvector_TYPE *vec, size_t num) {                        \
    TYPE *tmp;                                                                 \
    size_t tmp_sz;                                                             \
